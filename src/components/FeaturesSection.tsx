...
import { ArrowRight, Hand, MegaphoneIcon, GraduationCap } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="border-2 bg-card hover:shadow-md transition-shadow">
              <CardContent className="pt-6">
                ...
                <a href={index === 0 ? "/translate" : index === 1 ? "/about" : "/learn"} className="text-accent hover:text-accent/80 inline-flex items-center text-sm font-medium">
